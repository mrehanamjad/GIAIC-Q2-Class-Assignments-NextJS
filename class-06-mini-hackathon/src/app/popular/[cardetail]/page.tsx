            ...
            <Container>
              <div className='w-full max-w-4xl mx-auto text-center flex flex-col gap-10 justify-center items-center'>
                ...
                <div className='space-y-3 px-8'>
                  ...
                  <span><b>Number of Doors:</b> {car.vehicle_description.number_of_doors}</span>
                  <span><b>Engine:</b> {car.vehicle_description.engine}</span>
                  <span><b>Condition:</b> {car.vehicle_description.condition}</span>
                  <span><b>Driven:</b> {car.vehicle_description.driven}</span>
                  <span><b>Suspension Type:</b> {car.vehicle_description.suspension_type}</span>
                  <span><b>Avg:</b> {car.vehicle_description.avg_fuel_consumption}</span>
                  <span><b>Transmission:</b> {car.vehicle_description.transmission}</span>
                  <span><b>Fuel Type:</b> {car.vehicle_description.fuel_type}</span>
                  </div>
                </div>
